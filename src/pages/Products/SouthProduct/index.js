          ...
          <div className="content">
            <div className="row">
              <div className="col-md-6 col-lg-4">
                <div className="box1">
                  <img
                    src={doolin_house_dublin01}
                    className="img-fluid"
                    alt="Doolin House, Dublin"
                  />
                  <div className="text">
              ...
              <div className="col-md-6 col-lg-4">
                <div className="box1">
                  <img
                    src={glasnevin_dublin01}
                    className="img-fluid"
                    alt="Glasnevin, Dublin"
                  />
                  <div className="text">
              ...
              <div className="col-md-6 col-lg-4">
                <div className="box1">
                  <img
                    src={templeogue_dublin01}
                    className="img-fluid"
                    alt="Templeogue, Dublin"
                  />
                  <div className="text">
              ...
              <div className="col-md-6 col-lg-4">
                <div className="box1">
                  <img
                    src={killinick_wexford01}
                    className="img-fluid"
                    alt="Ballyfinogue House, Killinick, Wexford"
                  />
                  <div className="text">
